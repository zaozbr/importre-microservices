// Auto-gerado por _source_hunter.js para colecao archive.org: slpm-87056-winning-eleven-2002-rips
const axios = require('axios');
const { normalize, titleScore, buildSource } = require('./_base');

const HEADERS = { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36' };
const COLLECTION = 'slpm-87056-winning-eleven-2002-rips';
...
module.exports = {
  name: 'archive-slpm-87056-winning-eleven-2002-rips',
  matchType: 'title',
  ...
  async search(serial, title) {
    ...
    return scored.slice(0, 3).map(f =>
      buildSource('archive-slpm-87056-winning-eleven-2002-rips', f.url, title, { score: f.score, size: f.size })
    );
  }
};
