// Auto-gerado por _source_hunter.js para colecao archive.org: 2024-sony-playstation-usa-hearto-1g1r-collection
const axios = require('axios');
const { normalize, titleScore, buildSource } = require('./_base');

const HEADERS = { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36' };
const COLLECTION = '2024-sony-playstation-usa-hearto-1g1r-collection';
...
module.exports = {
  name: 'archive-2024-sony-playstation-usa-hearto-1g1r-collection',
  matchType: 'title',
  ...
  async search(serial, title) {
    ...
    return scored.slice(0, 3).map(f =>
      buildSource('archive-2024-sony-playstation-usa-hearto-1g1r-collection', f.url, title, { score: f.score, size: f.size })
    );
  }
};
